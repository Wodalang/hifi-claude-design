...
| 格式 | 规格 | 适合场景 | 典型大小（30s） |
|---|---|---|---|
| MP4 25fps | 1920×1080 · H.264 · CRF 18 | 视频平台嵌入、通用分发 | 1-2 MB |
| MP4 60fps | 1920×1080 · minterpolate 插帧 · H.264 · CRF 18 | 高帧率展示、作品集 | 1.5-3 MB |
| GIF | 960×540 · 15fps · palette 优化 | 社群平台、README、聊天工具预览 | 2-4 MB |
...
| minterpolate 插帧 | `convert-formats.sh in.mp4 --minterpolate` | macOS QuickTime/Safari 可能拒打 | 需要真插帧的展示场景，**交付前必须本地测**目标播放器 |
...
| 「GIF 太糊」 | 提高 `gif_width` 到 1280；或者建议用 MP4 代替 |
