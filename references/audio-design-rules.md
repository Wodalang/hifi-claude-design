# 音频设计规则 · hifi-claude-design

> 所有动画 demo 的音频应用配方。和 `sfx-library.md`（资产清单）配套使用。
> 实战锤炼：hifi-claude-design 发布 hero v1-v9 迭代 · Anthropic 三支官方片子的 Gemini 深度拆解 · 8000+ 次 A/B 对比
...
hifi-claude-design skill 自带 6 首 BGM（`assets/bgm-*.mp3`）：
...
### 配方 A · 产品发布 hero（hifi-claude-design v9 同款）
```
时长：25 秒
...
| mp4 自动播放没声音 | 部分平台会 mute auto-play | 不用担心，用户点开会有声音；gif 本来就没声音 |
...
- Anthropic 三支片子深度音频分析：见项目归档的 `AUDIO-BEST-PRACTICES.md`
- hifi-claude-design v9 实战案例：见项目归档的 `hero-animation-v9-final.mp4`
